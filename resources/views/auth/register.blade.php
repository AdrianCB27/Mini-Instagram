...
<div class="h-screen  py-20 overflow-y-auto">
    <div class="max-w-md mx-auto bg-white p-8 rounded-xl shadow-2xl border border-gray-200 mb-10">
        <h3 class="text-3xl font-extrabold mb-6 text-center text-blue-600">Registrarse</h3>
        <form action="/register" method="POST" class="space-y-6">
            @csrf
            <div>
                <label for="name" class="block text-gray-700 text-sm font-semibold">Nombre:</label>
                <input type="text" name="name" id="name" class="w-full mt-2 p-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent" required>
            </div>
            <div>
            ...
            <div>
                <label for="password_confirmation" class="block text-gray-700 text-sm font-semibold">Confirmar Contraseña:</label>
                <input type="password" name="password_confirmation" id="password_confirmation" class="w-full mt-2 p-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent" required>
            </div>
        ...
        <p class="mt-4 text-sm text-gray-600 text-center">¿Ya tienes una cuenta? <a href="/login" class="text-blue-500 hover:text-blue-700 font-semibold">Iniciar Sesión</a></p>
    </div>
</div>
@endsection