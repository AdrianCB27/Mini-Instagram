...
@section('contenido')
  ...
  <div class="flex justify-center mx-auto text-4xl text-white mt-5 font-bold">
    Tus posts, {{ auth()->user()->name }}
  </div>
  ...
  @if (count($posts) > 0)
    @cannot('read', $posts[0])
      <h1 class="text-center mx-auto text-4xl text-white">
        ¿Estás seguro que eres el propietario de este perfil? 🤔
      </h1>
      <div class="flex justify-center mx-auto mt-12 h-screen">
        <img style="width: 200px; height: 200px;" src="https://static.vecteezy.com/system/resources/thumbnails/012/042/292/small/warning-sign-icon-transparent-background-free-png.png" alt="">
      </div>
    @endcannot
  @else
    <h1 class="text-center mx-auto text-4xl text-white">
    ...
    <div class="flex justify-center mx-auto mt-12">
      <img src="https://upload.wikimedia.org/wikipedia/commons/3/33/Carita_triste_Ana_Mena.png" alt="">
    </div>
  @endif
